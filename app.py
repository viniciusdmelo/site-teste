...
planilha = api.open_by_key("1dTuzMid63IzSo_6J30zI0MegXCiROivFm8cw_fk2FBY")
sheet = planilha.worksheet("AULA_08")
...
def dedoduro():
  ...
  return f"""
  Mensagem enviada. <br>
  Resposta: ({resposta.status_code}) - {resposta.text} <br>
  Deseja escrever o seu acesso na planilha do Google? <a href="/dedodurogoogle">Clique aqui</a>.
  """
